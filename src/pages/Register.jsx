...
function Register() {
  ...
  return (
    <div style={{ width: '100%', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#c3e5fc', minHeight: '100vh', padding: '40px 20px', fontFamily: 'Inter, sans-serif' }}>
